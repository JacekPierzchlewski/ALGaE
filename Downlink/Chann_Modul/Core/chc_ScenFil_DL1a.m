%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% chc_ScenFil_DL1a: THE "ALGaE" PACKAGE - CHECK A FILE WITH LTE DOWNLINK
%                                         SCENARIO STRUCTURE   
%
...
% strucutre readed from the given file. Routine from 'chc_Scen_DL1a' file is
...
function [ sScen strErr ] = chc_ScenFil_DL1a(strFile,strPath)
