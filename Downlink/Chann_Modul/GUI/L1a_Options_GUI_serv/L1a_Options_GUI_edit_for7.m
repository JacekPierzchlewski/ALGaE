%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L1a_Options_GUI_edit_for7: THE "ALGaE" PACKAGE - GRAPHICAL USER INTERFACE,
%                                        STACK:  DOWNLINK,
%                                        MODULE: CHANNELS AND MODULATION,
%                                                OPTIONS
%
%                                      GUI SERVICES: EDIT FIELD 'Format of the 7th PDCCH channel'
%
...
%                       Possible service:
%
%                           - 'Create' (edit field 'Format of the 7th PDCCH channel')
%
%                           - 'Initialize' (edit field 'Format of the 7th PDCCH channel')
%
%                           - 'Callback' (edit field 'Format of the 7th PDCCH channel')
%
% ------------------------------------------------------------------------
% Output:
%
...
function L1a_Options_GUI_edit_for7(hObject, handles, strServ)
    
    % Run the correct service
    switch strServ
        
        % Create the edit text box 'Format of the 7th PDCCH channel'
        case 'Create'
            edit_for7_create(hObject);
            
        % Initialize the edit text box 'Format of the 7th PDCCH channel'
        case 'Initialize'
            edit_for7_init(handles);
            
        % Callback the edit text box 'Format of the 7th PDCCH channel'
        case 'Callback'
            edit_for7_callback(hObject, handles);
    end
end


%% Service: create GUIedit_for7_PDCCH object (text field 'Format of the 7th PDCCH channel')
function edit_for7_create(hObject)
...
%% Service: initialize GUIedit_for7_PDCCH object (text field 'Format of the 7th PDCCH channel')
function edit_for7_init(handles)
    ...
    if nPDCCH < 7
        ...
        set(handles.GUIedit_for7_PDCCH,'String',' ');
    else
        ...
        set(handles.GUIedit_for7_PDCCH,'String',num2str(vPDCCHFor(7)));
    end
    % ---------------------------------------
...
%% Service: callback GUIedit_for7_PDCCH object (text field 'Format of the 7th PDCCH channel')
function edit_for7_callback(hObject, handles)
    ...
    if abs(iVal - iVal_old) > 0.000001
        ...
        set(hObject,'String',num2str(sL1a.vPDCCH_Form(7)));
