%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L1a_Options_GUI_edit_for4: THE "ALGaE" PACKAGE - GRAPHICAL USER INTERFACE,
%                                        STACK:  DOWNLINK,
%                                        MODULE: CHANNELS AND MODULATION,
%                                                OPTIONS
%
%                                      GUI SERVICES: EDIT FIELD 'Format of the 4th PDCCH channel'
%
...
%                       Possible service:
%
%                           - 'Create' (edit field 'Format of the 4th PDCCH channel')
%
%                           - 'Initialize' (edit field 'Format of the 4th PDCCH channel')
%
%                           - 'Callback' (edit field 'Format of the 4th PDCCH channel')
%
% ------------------------------------------------------------------------
% Output:
%
...
function L1a_Options_GUI_edit_for4(hObject, handles, strServ)
    
    % Run the correct service
    switch strServ
        
        % Create the edit text box 'Format of the 4th PDCCH channel'
        case 'Create'
            edit_for4_create(hObject);
            
        % Initialize the edit text box 'Format of the 4th PDCCH channel'
        case 'Initialize'
            edit_for4_init(handles);
            
        % Callback the edit text box 'Format of the 4th PDCCH channel'
        case 'Callback'
            edit_for4_callback(hObject, handles);
    end
end


%% Service: create GUIedit_for4_PDCCH object (text field 'Format of the 4th PDCCH channel')
function edit_for4_create(hObject)
...
%% Service: initialize GUIedit_for4_PDCCH object (text field 'Format of the 4th PDCCH channel')
function edit_for4_init(handles)
    ...
    if nPDCCH < 4
        ...
        set(handles.GUIedit_for4_PDCCH,'String',' ');
    else
        ...
        set(handles.GUIedit_for4_PDCCH,'String',num2str(vPDCCHFor(4)));
    end
    % ---------------------------------------
end
...
%% Service: callback GUIedit_for4_PDCCH object (text field 'Format of the 4th PDCCH channel')
function edit_for4_callback(hObject, handles)
    ...
    if abs(iVal - iVal_old) > 0.000001
        ...
        set(hObject,'String',num2str(sL1a.vPDCCH_Form(4)));
