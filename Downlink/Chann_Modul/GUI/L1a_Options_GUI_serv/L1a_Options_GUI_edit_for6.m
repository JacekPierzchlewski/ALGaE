%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L1a_Options_GUI_edit_for6: THE "ALGaE" PACKAGE - GRAPHICAL USER INTERFACE,
%                                        STACK:  DOWNLINK,
%                                        MODULE: CHANNELS AND MODULATION,
%                                                OPTIONS
%
%                                      GUI SERVICES: EDIT FIELD 'Format of the 6th PDCCH channel'
%
...
%                       Possible service:
%
%                           - 'Create' (edit field 'Format of the 6th PDCCH channel')
%
%                           - 'Initialize' (edit field 'Format of the 6th PDCCH channel')
%
%                           - 'Callback' (edit field 'Format of the 6th PDCCH channel')
%
% ------------------------------------------------------------------------
% Output:
%
...
function L1a_Options_GUI_edit_for6(hObject, handles, strServ)
    
    % Run the correct service
    switch strServ
        
        % Create the edit text box 'Format of the 6th PDCCH channel'
        case 'Create'
            edit_for6_create(hObject);
            
        % Initialize the edit text box 'Format of the 6th PDCCH channel'
        case 'Initialize'
            edit_for6_init(handles);
            
        % Callback the edit text box 'Format of the 6th PDCCH channel'
        case 'Callback'
            edit_for6_callback(hObject, handles);
    end
end


%% Service: create GUIedit_for6_PDCCH object (text field 'Format of the 6th PDCCH channel')
function edit_for6_create(hObject)
...
%% Service: initialize GUIedit_for6_PDCCH object (text field 'Format of the 6th PDCCH channel')
function edit_for6_init(handles)
    ...
    if nPDCCH < 6
        ...
        set(handles.GUIedit_for6_PDCCH,'String',' ');
    else
        ...
        set(handles.GUIedit_for6_PDCCH,'String',num2str(vPDCCHFor(6)));
    end
    % ---------------------------------------
...
%% Service: callback GUIedit_for6_PDCCH object (text field 'Format of the 6th PDCCH channel')
function edit_for6_callback(hObject, handles)
    ...
    if abs(iVal - iVal_old) > 0.000001
        ...
        set(hObject,'String',num2str(sL1a.vPDCCH_Form(6)));
