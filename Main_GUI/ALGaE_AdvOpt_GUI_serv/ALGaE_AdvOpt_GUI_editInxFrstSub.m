%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ALGaE_AdvOpt_GUI_editInxFrstSub: THE "ALGaE" PACKAGE - GRAPHICAL USER INTERFACE,
%                                                MODULE: MAIN GUI, OPTIONS
%                                            
%                                                GUI SERVICES: 
%                                                   EDIT FIELD 'Index of the first generated subframe'
%
...
%                       Possible service:
%
%                           - 'Create' (edit text 'Index of the first...')
%
%                           - 'Initialize' (edit text 'Index of the first...')
%
%                           - 'Callback' (edit text 'Index of the first...')
%
% ------------------------------------------------------------------------
% Output:
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ALGaE_AdvOpt_GUI_editInxFrstSub(hObject, handles, strServ)
 
    % Run the correct service
    switch strServ
                
        % Create the text edit box  'Index of the first...'
        case 'Create'
            edit_InxFrstSub_create(hObject);
            
        % Initialize the text edit box 'Index of the first...'
        case 'Initialize'
            edit_InxFrstSub_init(handles);

        % Callback the text edit box 'Index of the first...'
        case 'Callback'
            edit_InxFrstSub_callback(hObject,handles);
    end
end


%% Service: create GUIedit_FrstSub object (list box 'Index of the first...')
function edit_InxFrstSub_create(hObject)
...
%% Service: initialize GUIedit_FrstSub object (list box 'Index of the first...')
function edit_InxFrstSub_init(handles)

    % Get the sScen scenario structure
    sScen = getappdata(handles.figure1,'sScen');
    
    % Initialize the correct value
    set(handles.GUIedit_FrstSub,'String',num2str(sScen.FIRST_SF));
end


%% Service: callback of the GUIedit_FrstSub object (list box 'Index of the first...')
function edit_InxFrstSub_callback(hObject,handles)
    ...
    % Get the number of Subframes in a Radioframe
    ...
    if abs(iVal - iVal_old) > 0.000001
        ...
        set(hObject,'String',num2str(sScen.FIRST_SF));
    ...
    if isnan(iVal)
        ...
        % Put the error box
        waitfor(errordlg('This value must be a numeric!','Error!'));
        return;        
    end
