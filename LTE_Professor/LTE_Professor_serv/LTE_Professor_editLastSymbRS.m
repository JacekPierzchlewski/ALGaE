%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LTE_Professor_editLastSymbRS: THE "ALGaE" PACKAGE - GRAPHICAL USER INTERFACE,
%                                                     MODULE: LTE PROFESSOR
%                  
%                                                     SERVICE: EDIT FIELD 'Last Symbol, Symbol in Radio Slot Index'
%                                                     (GUI object: 'Edit_lastSymbRS')
%                                                                                                                            
...
%                       Possible service:
%
%                           - 'Create' (Edit field 'Last Symbol, Symbol in Radio Slot Index')
%
%                           - 'Callback' (Edit field 'Last Symbol, Symbol in Radio Slot Index')
%
% ------------------------------------------------------------------------
% Output:
%
...
function LTE_Professor_editLastSymbRS(hObject, handles, strServ)
    ...
    switch strServ
        ...
        % Create
        case 'Create'
            LastSymbRS_create(hObject);

        % Callback
        case 'Callback'
            LastSymbRS_callback(hObject,handles);
    end
end


%% Service: create 'Edit_lastSymbRS' object
function LastSymbRS_create(hObject)
...
%% Service: edit 'Edit_lastSymbRS' object
function LastSymbRS_callback(hObject,handles)
    ...
    if isnan(inxVal)
        ...
        strFrst = num2str(inxLastSymbsRS);  % Last
    ...
    inxLastSymbsRS = round(inxVal);        
    if inxLastSymbsRS < 0
        inxLastSymbsRS = 0;
    end
    
    if inxLastSymbsRS > N_symbDL
        inxLastSymbsRS = N_symbDL;
    end
